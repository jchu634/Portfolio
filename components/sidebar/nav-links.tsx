          ...
          return (
            <Link
              ...
              className={clsx(
                ...
                {
                  'bg-sky-800 md:bg-sky-200 text-white md:text-blue-600 font-extrabold dark:text-emerald-600 dark:bg-cyan-200 dark:md:bg-blue-950 dark:md:text-blue-400': pathname === link.href,
                }
              )}
            >
