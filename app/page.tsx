...
export default function Home() {
  ...
  return (
    <div className="h-full w-full" ref={(node) => setContainer(node)}>
      <div
        className="relative h-1/4 w-3/4 cursor-pointer items-center justify-center overflow-hidden rounded-lg"
        ref={containerRef}
      >
      ...
      >
        ...
        <div className="relative flex h-80 w-full flex-col items-end overflow-hidden">
          <h2
            className={cn(
              "absolute bottom-12 left-0 translate-y-1/3 text-[80px] text-[#ff5941] sm:text-[122px]",
              roboto_slab.className,
            )}
          >
            JOSHUA CHUNG ©2025
          </h2>
          <div className="r-0 absolute bottom-5 flex flex-row">
            <Button variant="ghostnohover" size="icon" asChild>
            ...
            <Button variant="ghostnohover" size="icon" asChild>
              <Link href="https://github.com/jchu634">
                <SiGithub className="size-8 text-black dark:text-white" />
              </Link>
            </Button>
            ...
            <Button variant="ghostnohover" size="icon" asChild>
              <Link href="mailto:jchu634@keshuac.com">
                <MailIcon className="size-8 text-black dark:text-white" />
              </Link>
            </Button>
          </div>
        </div>
